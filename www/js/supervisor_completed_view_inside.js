...
/*$(".s2").append('<li><a href="images/image2.jpg"><img src="images/image2.jpg" style="height: 50px;"/></a></li>');

$(".s2").append('<li><a href="images/images3333.jpg"><img src="images/images3333.jpg" style="height: 50px;" /></a></li> ');

$(".s2").append(' <li><a href="images/image1.jpg"><img src="images/image1.jpg" style="height: 50px;"/></a></li>');
*/
...
*/
  ...
  for(a=0;a<employment_upload_array.length;a++){
    ...
    if(empimgempl == qualification_id && empidempl == verification_user_id ){
     ...
     $('.s2').append('<li><a href="http://staging.eimpressive.com/watchguardlive/uploads/'+one+'"><img src="http://staging.eimpressive.com/watchguardlive/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
      ...
      if (k == 1 ){
        ...
        //alert(oneo+'two');
     $('.s2').append('<li><a href="http://staging.eimpressive.com/watchguardlive/uploads/'+oneo+'"><img src="http://staging.eimpressive.com/watchguardlive/uploads/'+oneo+'"  style="height: 300px;width:350px"></a></li>');
...
if (j == 0 ){
  ...
  $('.s2').append('<li><a href="http://staging.eimpressive.com/watchguardlive/documents/addressid/'+one+'"><img src="http://staging.eimpressive.com/watchguardlive/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
if (j == 1 ){
  ...
  //alert(oneo+'two');
  $('.s2').append('<li><a href="http://staging.eimpressive.com/watchguardlive/documents/addressid/'+oneo+'"><img src="http://staging.eimpressive.com/watchguardlive/documents/addressid/'+oneo+'"  style="height: 300px;width:350px"></a></li>');
