...
$('.rejectb').append('<img src="http://115.118.113.83/watchguardlive/uploads/'+one+'" alt="Band"  class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneo+'two');
$('.rejectd').append('<img src="http://115.118.113.83/watchguardlive/uploads/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( k == 2){
  var oneoo=oneemploy[k];
//alert(oneoo+'3');
$('.rejectc').append('<img src="http://115.118.113.83/watchguardlive/uploads/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( k == 3){
  var oneooo=oneemploy[k];
// alert(oneooo+'4');
$('.rejecta').append('<img src="http://115.118.113.83/watchguardlive/uploads/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( k == 4){
  var oner=oneemploy[k];
// alert(oner+'5');
$('.rejecte').append('<img src="http://115.118.113.83/watchguardlive/uploads/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
if ( k == 5){
  var oner=oneemploy[k];
// alert(oner+'6');
$('.rejectf').append('<img src="http://115.118.113.83/watchguardlive/uploads/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
